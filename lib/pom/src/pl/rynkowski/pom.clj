...
(comment
 ...
 (gen-xml)
 (spit (jio/file "target" "pom.xml") (xml/indent-str (gen-pom-xml)))
 @(def pom-file (api/resolve-path "pom.xml"))

 (let [version "1.0.1"]
   (-> (gen-pom-xml {:artifact-id "name-ilb"
                     :group-id "com.twobuffers"
                     :version version
                     :scm {:tag (str "v" version)}
                     :basis {:libs {'org.clojure/clojure {:mvn/version "1.11.1"}}}})

       #_(xml/indent-str)
       #_(->> (spit (jio/file "target" "pom.xml"))))),)
